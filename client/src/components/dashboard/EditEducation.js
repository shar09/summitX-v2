...
import EducationConfirmDialog from './EducationConfirmDialog';
    ...
    return (
        !showEdit[1] ? (
            ...
            <Fragment>
                ...
                { confirmDialog ? (
                    <EducationConfirmDialog deleteEducation={deleteEducation} showConfirmDialog={showConfirmDialog} edu={edu} />
                ): <Fragment />
                }
            </Fragment>
        )
